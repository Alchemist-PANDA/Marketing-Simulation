...
by_id = {}
for a in wave1 + wave2 + wave3:
    by_id[a["id"]] = a

ads = list(by_id.values())
print(f"Merged unique ads: {len(ads)} (wave1={len(wave1)}, wave2={len(wave2)}, wave3={len(wave3)})")
...
ads_path = f"{OUT_DIR}/merged3_ads_clean.csv"
...
pairs_path = f"{OUT_DIR}/merged3_validation_pairs.csv"
