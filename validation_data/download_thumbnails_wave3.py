"""
Download cover thumbnails for the 284 new wave-3 ads only (bandwidth only,
...
ADS_PATH = "/home/user/Marketing-Simulation/validation_data/wave3_ads_clean.csv"
...
print(f"Downloaded + featurized {ok}/{len(targets)} wave-3 thumbnails")
