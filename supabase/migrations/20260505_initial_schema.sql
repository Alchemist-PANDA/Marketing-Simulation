...
-- Indexes
create index idx_ad_variants_campaign_id on public.ad_variants(campaign_id);
create index idx_ad_variants_user_id on public.ad_variants(user_id);
-- RLS
...
-- Indexes
create index idx_simulation_runs_variant_id on public.simulation_runs(variant_id);
create index idx_simulation_runs_user_id on public.simulation_runs(user_id);
create index idx_simulation_runs_timestamp on public.simulation_runs(timestamp);
-- RLS
